...
dataframe_AmazonKinesis_node1755779992163 = glueContext.create_data_frame.from_options(
    ...
    transformation_ctx="dataframe_AmazonKinesis_node1755779992163"
)

glueContext.forEachBatch(
    frame=dataframe_AmazonKinesis_node1755779992163,
    batch_function=processBatch,
    options={
        "windowSize": "80 seconds",

...
dataframe_AmazonKinesis_node1755010546884 = glueContext.create_data_frame.from_options(connection_type="kinesis",connection_options={"typeOfData": "kinesis", "streamARN": "arn:aws:kinesis:us-east-1:851725381788:stream/Aug12th", "classification": "json", "startingPosition": "earliest", "inferSchema": "true"}, transformation_ctx="dataframe_AmazonKinesis_node1755010546884")



glueContext.forEachBatch(frame = dataframe_AmazonKinesis_node1755010546884, batch_function = processBatch, options = {"windowSize": "80 seconds", "checkpointLocation": args["TempDir"] + "/" + args["JOB_NAME"] + "/checkpoint/"})
job.commit()

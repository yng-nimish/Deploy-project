...
def MyTransform(glueContext, dfc) -> DynamicFrameCollection:
        dynamic_frame = dfc["AmazonKinesis_node1737484028867"]
...
dataframe_AmazonKinesis_node1737484028867 = glueContext.create_data_frame.from_options(connection_type="kinesis",connection_options={"typeOfData": "kinesis", "streamARN": "arn:aws:kinesis:us-east-1:851725381788:stream/expo", "classification": "json", "startingPosition": "earliest", "inferSchema": "true"}, transformation_ctx="dataframe_AmazonKinesis_node1737484028867")
...
def processBatch(data_frame, batchId):
    if (data_frame.count() > 0):
        AmazonKinesis_node1737484028867 = DynamicFrame.fromDF(data_frame, glueContext, "from_data_frame")
        # Script generated for node Custom Transform
        CustomTransform_node1736967498329 = MyTransform(glueContext, DynamicFrameCollection({"AmazonKinesis_node1737484028867": AmazonKinesis_node1737484028867}, glueContext))
...
glueContext.forEachBatch(
    frame = dataframe_AmazonKinesis_node1737484028867, 
